...
public class BibliotecaABB implements Biblioteca {
	...
	private void ordenarPorPrecio() {
		...
		ArrayList<MaterialCapacitacion> materialesAux = (ArrayList<MaterialCapacitacion>) this.materiales.inOrden();
		for(MaterialCapacitacion aux : materialesAux) {
			arbolAux.add(aux);
		}
		
		this.materiales = arbolAux;
	}
	...
	private void ordenarPorTitulo() {
		...
		ArbolBinarioBusqueda arbolAux = new ArbolBinarioBusqueda(comparaTitulo);
		ArrayList<MaterialCapacitacion> materialesAux = (ArrayList<MaterialCapacitacion>) this.materiales.inOrden();
		for(MaterialCapacitacion aux : materialesAux) {
			arbolAux.add(aux);
		}
